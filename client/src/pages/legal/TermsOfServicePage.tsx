...
export function TermsOfServicePage() {
  return (
    <LegalPageLayout title="Terms of Service">
      ...
      <LegalSection title="6. Reporting, blocking, and moderation">
        <p>
          You can report or block any user, photo, voice recording, profile, or message
      ...
      <LegalSection title="8. Content you post">
        <p>
      ...
      <LegalSection title="9. Disclaimers">
        <p>
          ...
          fit — it's a tool, not a guarantee of romantic or personal compatibility. We're not
