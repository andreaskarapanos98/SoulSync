...
import { COIN_PACKAGES, UNLOCK_COST_COINS, createCheckoutSession } from "../services/coinService.js";
...
coinsRouter.get("/packages", async (req, res) => {
  ...
  res.json({ packages: COIN_PACKAGES, unlockCostCoins: UNLOCK_COST_COINS });
});
